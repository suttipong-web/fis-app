      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            <h3 class="font-weight-bold">Welcome To : {{ session('uname') ?? 'Guest' }} </h3>
          ...
          <div class="col-md-4 mb-4 stretch-card transparent">
            <div class="card card-tale">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2 ">จัดการงบประมาณ</p>
                <p> (50 รายการ)</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-4 stretch-card transparent">
            <div class="card card-dark-blue">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2">สำรองงบประมาณ</p>
                <p>(30 รายการ)</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-4 stretch-card transparent">
            <div class="card card-light-blue">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2">เบิกงบประมาณ</p>
                <p>(30 รายการ)</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card " style="background-color:antiquewhite;">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2">โอนงบประมาณ</p>
                <p>(30 รายการ)</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card" style="background-color:aqua;">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2">เบิกเกินส่งคืน</p>
                <p>(30 รายการ)</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-4 mb-lg-0 stretch-card transparent">
            <div class="card card-light-danger">
              <div class="card-body text-center">
                ...
                <p class="fs-25 mb-2">ติดตามสถานะ</p>
                <p>(50 รายการ)</p>
              </div>
            </div>
          </div>
